...
# JHerndon,11.23.20,Modified code to complete assignment 6
# ---------------------------------------------------------------------------- #
...
class IO:
    ...
    def input_new_task_and_priority():
        ...
        priority = str(input("Enter a 'Priority' (high, medium or low): ")).strip()
        #  list_of_rows = (strTask, strPriority)
        #  dicRow = {"Task": list_of_rows[0], "," "Priority": list_of_rows[1]}
